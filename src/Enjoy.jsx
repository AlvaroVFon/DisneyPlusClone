    ...
    <>
      <div className="bg-[#050614] flex flex-col items-center">
        <div className="flex flex-col items-center justify-center pt-20">
          ...
          <p className="px-10 pt-10 text-sm tracking-wide text-center text-white/60 lg:text-2xl">Disfruta de las mejores historias, en cualquier momento y en cualquier lugar</p>
        </div>
        <picture>
